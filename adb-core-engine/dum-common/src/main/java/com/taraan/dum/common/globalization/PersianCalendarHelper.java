...
import static com.taraan.dum.common.globalization.PersianCalendarUtils.EPOCH;
import static com.taraan.dum.common.globalization.PersianCalendarUtils.div;
import static com.taraan.dum.common.globalization.PersianCalendarUtils.mod;
...
public class PersianCalendarHelper
{
	...
	*/
	public static long pj(long y, int m, int d)
	{
		...
		return (EPOCH - 1L) + 1029983L * div(a, 2820D) + 365L * (b - 1L) + div(682L * b - 110L, 2816L) + (long)(m > 6? 30 * m + 6: 31 * m) + (long)d;
	}
	/**
