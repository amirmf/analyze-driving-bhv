...
//        System.out.println(Long.valueOf((long) Math.floor(1.5d)));
...
//        System.out.println("to:" + getDate("2018-04-22 21:10:44").getTime());
    ...
    public static Date getDate(String date, boolean ignoreException) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            return sdf.parse(date);
        } catch (Exception e) {
    ...
    public static Date addDay(Date fromDate, int i) {
